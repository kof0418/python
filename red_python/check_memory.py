...
DEFAULT_WARNING_FREE = 2
DEFAULT_CRITICAL_FREE = 1.5
...
def check_memory():
    ...
    if mem_total < 1048576:
        msg = "{0}% - {1} / {2} MB used. Free memory: {3} MB, min free memory: {4} MB.".format(percentage, used_mem / 1024, mem_total / 1024, mem_free / 1024, min_free_kbytes / 1024)
    else:
        msg = "{0}% - {1} / {2} GB used. Free memory: {3} MB, min free memory: {4} MB.".format(percentage, used_mem / 1024 / 1024, mem_total / 1024 / 1024, mem_free / 1024, min_free_kbytes / 1024)
